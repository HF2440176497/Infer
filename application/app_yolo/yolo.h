...
std::shared_ptr<Infer> create_infer(const std::string& engine_file, int gpuid, float confidence_threshold = 0.50f,
                                    float nms_threshold = 0.25f, int max_objects = 512,
